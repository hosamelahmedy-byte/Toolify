...
const PAGE_TITLE = 'AI Quiz Generator — Create Quizzes Instantly | Toolify'
const PAGE_DESCRIPTION =
  'Generate custom quizzes on any topic with AI. Choose difficulty, question type, and number of questions. Free, no signup required.'
const PAGE_URL = 'https://toolify.app/tools/quiz-generator'
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta property="og:image" content="https://toolify.app/og/quiz-generator.png" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={PAGE_TITLE} />
        <meta name="twitter:description" content={PAGE_DESCRIPTION} />
        <meta name="twitter:image" content="https://toolify.app/og/quiz-generator.png" />
