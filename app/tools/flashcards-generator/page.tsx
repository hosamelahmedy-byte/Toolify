...
const PAGE_TITLE = 'AI Flashcards Generator — Create Study Cards Instantly | Toolify'
const PAGE_DESCRIPTION =
  'Turn any topic or text into study flashcards with AI. Perfect for students, teachers & lifelong learners. Free, no signup required.'
const PAGE_URL = 'https://toolify.app/tools/flashcards-generator'
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content="https://toolify.app/og/flashcards-generator.png" />
