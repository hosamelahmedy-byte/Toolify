...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Online Calculators — Toolify', description: 'BMI, loan, unit converter & age calculator. Free, instant, no signup.', url: 'https://toolify-iota-gules.vercel.app/tools/calculator', type: 'website' },
  ...
  alternates: { canonical: 'https://toolify-iota-gules.vercel.app/tools/calculator' },
}
...
const jsonLd = {
  ...
  url: 'https://toolify-iota-gules.vercel.app/tools/calculator',
  description: 'Free online calculators including BMI calculator, loan calculator, unit converter, and age calculator.',
  inLanguage: 'en',
  isPartOf: { '@type': 'WebSite', name: 'Toolify', url: 'https://toolify-iota-gules.vercel.app' },
