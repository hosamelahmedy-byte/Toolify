...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Free Word Counter — Real-Time Text Analysis', description: 'Count words, characters & get readability scores instantly.', url: 'https://toolify-iota-gules.vercel.app/tools/word-counter' },
}
