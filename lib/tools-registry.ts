...
export const TOOLS: Tool[] = [
  ...
  // ── AI Learning & Productivity Tools ────────────────────────
  {
    id: 'quiz-generator',
    slug: 'quiz-generator',
    name: 'AI Quiz Generator',
    description: 'Generate custom quizzes on any topic with AI. Multiple choice, true/false, or mixed. Export as JSON. Free, no signup.',
    category: 'ai-content',
    icon: BookOpen,
    color: 'from-violet-500 to-indigo-600',
    accentColor: '243, 75%, 59%',
    tags: ['quiz', 'AI', 'education', 'MCQ', 'study', 'free'],
    featured: true,
    new: true,
    popular: false,
  },
  {
    ...
    description: 'Turn any text or topic into study flashcards instantly with AI. Question & answer format. Free, no signup.',
    category: 'ai-content',
    icon: Layers,
    color: 'from-sky-500 to-cyan-500',
    accentColor: '199, 80%, 55%',
    tags: ['flashcards', 'AI', 'study', 'education', 'memorize', 'free'],
    featured: true,
    new: true,
    popular: false,
  },
  {
    ...
    tags: ['PDF', 'summarize', 'AI', 'summary', 'key points', 'free'],
    featured: true,
    new: true,
    popular: false,
  },
  {
    ...
    tags: ['image', 'background remover', 'AI', 'transparent', 'free', 'no watermark'],
    featured: true,
    new: true,
    popular: false,
  },
